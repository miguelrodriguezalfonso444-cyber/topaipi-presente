      ...
      <div className="max-w-7xl mx-auto">
        <header className="bg-white shadow rounded-lg p-6 mb-6 flex flex-col md:flex-row justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500">Sistema de Control de Asistencia y Gestión Académica</p>
          </div>
        ...
        {activeTab === 'admin' && (
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <p className="text-gray-600 mb-6">Gestión de usuarios, permisos y configuración general del sistema.</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="border p-4 rounded-lg bg-gray-50">
                <h3 className="font-medium text-gray-700 mb-3 flex items-center gap-2">
                  <UserPlus className="w-4 h-4 text-green-600" /> Usuarios Registrados ({usuarios.length})
                </h3>
              ...
              <div className="border p-4 rounded-lg bg-gray-50">
                ...
                <p className="text-sm text-gray-600 mb-2">Estado de la Base de Datos: <span className="text-green-600 font-bold">Conectado</span></p>
                <p className="text-sm text-gray-600">Versión actual: 1.0.0 Estable</p>
              </div>
            </div>
          </div>
        )}
